...
# and instances should respond to a match method that takes an array of possible anagrams. 
...
# Instructions
# Once again, this lab is test-driven. 
# Run the test suite to get started. 
# Remember that you can use the learn/rspec --fail-fast option to run the tests only up until the first failure, 
# in order to work progressively through the tests.
...
# This will help in your comparison:
